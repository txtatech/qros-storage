...
class FileProcessor:
    ...
    def compress_and_generate_base64_chunks(self, file_name, chunk_size=1500, output_file_name=None):
        ...
        final_output_file_name = output_file_name if output_file_name else f'{file_name}-qros-dna.json'
...
def main():
    ...
    mg = MappingGenerator('inputs/dna/qros-dna-readme.txt', 'outputs')
    ...
    # Define the path to the 'qros_dna_main.py' file
    qros_dna_main_path = os.path.join(os.path.dirname(__file__), 'qros_dna_main.py')
    ...
    subprocess.run(['python3', 'qros_dna_chunker.py'])
