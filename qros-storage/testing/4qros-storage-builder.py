...
img_file_path = 'encoded_dna_full.json'
...
try:
    ...
    with open("decoded_encoded_dna_full.json", "wb") as out_file:
        out_file.write(decompressed_data)
    print("Data decompressed and written to 'decoded_encoded_dna_full.json'.")
except Exception as e:
