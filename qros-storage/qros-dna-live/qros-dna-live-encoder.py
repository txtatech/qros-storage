...
def compress_and_generate_base64_chunks(file_path, chunk_size=1500):
    ...
    json_file_path = os.path.join('outputs', 'file-qros-dna-zip.json')
...
file_path = 'inputs/files/qros-dna.zip'
...
def compress_and_generate_base64_chunks(file_path, chunk_size=1500):
    ...
    # Write chunks to a JSON file
    json_file_path = os.path.join('outputs', 'file-v86wasm.json')
    with open(json_file_path, 'w') as json_file:
        json.dump({"chunks": chunks}, json_file)  # Save the chunks as an array within a JSON object
...
def compress_and_generate_base64_chunks(file_path, chunk_size=1500):
    ...
    # Write chunks to a JSON file
    json_file_path = os.path.join('outputs', 'chunks.json')
    with open(json_file_path, 'w') as json_file:
        json.dump({"chunks": chunks}, json_file)  # Save the chunks as an array within a JSON object
...
# File to be processed
file_path = 'outputs/encoded_dna_data.json'
compress_and_generate_base64_chunks(file_path)
