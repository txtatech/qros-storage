...
img_file_path = 'Virtual_Forest_Epoch_Rising.txt'
...
try:
    ...
    with open("decoded_Virtual_Forest_Epoch_Rising.txt", "wb") as out_file:
        out_file.write(decompressed_data)
    print("Data decompressed and written to 'decoded_Virtual_Forest_Epoch_Rising.txt'.")
except Exception as e:
