...
def compress_and_generate_base64_qr_images(file_path, chunk_size=1500):
    ...
    with open('v86wasm.json', 'w') as json_file:
...
os.system('ffmpeg -framerate 30 -i qrs/qr_%09d.png -vf "scale=730:730,setsar=1" -an -c:v libx264 -pix_fmt yuv420p v86.wasm.mp4')
...
video_capture = cv2.VideoCapture('v86.wasm.mp4')
...
try:
    ...
    with open("decoded_v86.wasm", "wb") as out_file:
